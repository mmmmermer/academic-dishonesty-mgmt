...
AUDIT_BACKUP = "BACKUP"
AUDIT_RESET_PWD = "RESET_PWD"
AUDIT_TOGGLE_USER = "TOGGLE_USER"
AUDIT_EXPORT = "EXPORT"
AUDIT_QUERY_LIST = "QUERY_LIST"
...
AUDIT_TYPE_NAMES = {
    ...
    AUDIT_RESTORE: "恢复",
    AUDIT_BACKUP: "备份/恢复",
    AUDIT_RESET_PWD: "密码重置",
    AUDIT_TOGGLE_USER: "账号启停",
    AUDIT_EXPORT: "数据导出",
    AUDIT_QUERY_LIST: "名单查询",
}
...
LABEL_MAJOR = "所在单位"
LABEL_REASON = "认定结论"
LABEL_PUNISHMENT_DATE = "认定日期"
LABEL_PUNISHMENT_TIME = "认定时间"
LABEL_IMPACT_START = "处理起时间"
LABEL_IMPACT_END = "处理止时间"
LABEL_IN_IMPACT = "影响期"
# 通用提示句尾（失败类）
MSG_TRY_AGAIN = "请稍后重试。"
MSG_TRY_AGAIN_OR_ADMIN = "请稍后重试或联系管理员。"
# 登录页
TITLE_APP = "华中科技大学学术道德监督管理系统"
SUBTITLE_LOGIN = "请登录"
LABEL_LOGIN_USERNAME = "账号"
LABEL_LOGIN_PASSWORD = "密码"
BTN_LOGIN = "登录"
MSG_ENTER_USERNAME_PASSWORD = "请输入账号和密码。"
MSG_USERNAME_TOO_LONG = "账号长度超出限制，请检查后重试。"
MSG_LOGIN_TOO_MANY_FAIL = "登录失败次数过多，请 5 分钟后再试。"
MSG_LOGIN_WRONG = "账号或密码错误。"
...
CAPTION_BATCH_INTRO = f"上传包含「{LABEL_STUDENT_ID}」列的 Excel（.xlsx / .xls），与生效名单比对；可下载比对结果。"
# 空状态与操作反馈
