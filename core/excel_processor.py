"""
Excel 处理与解析中心：负责大文件读取、清洗、学号智能侦测等逻辑
"""
import re
...
# 会在这个模块中内部调用 core.student_id 里面的字符清洗逻辑
from .student_id import clean_student_id

try:
    from .config import MAX_IMPORT_ROWS, MAX_UPLOAD_FILE_BYTES, LABEL_STUDENT_ID
except ImportError:
...
_ID_COLUMN_ALIASES = {"学号", "工号", "工号/学号", "学号/工号", "编号", "考号", "考生号", "准考证号", "证件号", "ID", "id", "学工号"}
