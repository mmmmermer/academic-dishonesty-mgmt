...
from .file_safe_guard import _resolve_pdf_local_path
...
def render_pdf_preview(reason_field: str, key_suffix: str = "") -> None:
    ...
    """
    abs_path = _resolve_pdf_local_path(reason_field)
    if abs_path is None:
    ...
    # reason_field 格式为 /app/static/pdfs/xx/UUID.pdf，Streamlit 直接服务
