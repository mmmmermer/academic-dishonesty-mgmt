...
| 文档 | 说明 |
|------|------|
| [docs/系统需求与架构总文档.md](docs/系统需求与架构总文档.md) | 需求、架构、规模评估、部署与可扩展性总览（合并精炼） |
| [docs/审计总结记录.md](docs/审计总结记录.md) | 阶段一～四审计结论、死代码/幻觉/边界修复、安全性摘要 |
| [docs/阶段一实施说明.md](docs/阶段一实施说明.md) ～ [阶段四](docs/阶段四实施说明.md) | 数据库与连接、查询与导出、多实例、运维与体验 |
| [docs/阶段一二三四审计报告.md](docs/阶段一二三四审计报告.md) | 阶段一～四整体审计报告全文 |
| [deploy/README.md](deploy/README.md) | 多实例与备份示例（Nginx、启动脚本、备份脚本） |
